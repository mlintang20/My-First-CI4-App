...
<div class="container">
  <div class="row">
    <div class="col-8">
      <h1 class="my-3">Form Edit Data Komik</h1>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-8">
            <div class="input-group">
              <input type="file" class="form-control <?= ($validation->hasError('sampul')) ? 'is-invalid' : ''; ?>" id="sampul" name="sampul" onchange="imagePreview()" aria-describedby="inputGroupFileAddon04" aria-label="Upload" value="<?= $komik['sampul']; ?>">
              <div class="invalid-feedback">
                <?= $validation->getError('sampul'); ?>
              </div>
              <!-- <label class="input-group-text" for="sampul">Old File: <?= $komik['sampul']; ?></label> -->
            </div>
          </div>
        </div>
